...
var core = exports.core = {
    ...
    shop: function (showDisplay) {
        var shop = [
			//['Staff hug', 'Get a hug from a staff member + and up',1],
			//['Motts Apple Sauce','The best substance on the earth. Makes you infinitely good at tours. Totally.', 5],
			//['sableye hugz', 'Buy a hug from our very own admin Wine!', 10],
			['Fix', 'Buys the ability to alter your current custom avatar or trainer card. (don\'t buy if you have neither)', 10],
            ['Custom avatar', 'Buys a custom avatar to be applied to your name. (you supply)', 20],
            ['Trainer Card', 'Buy a trainer card, this requires some common sense, PM Rival Nick for more info',30],
			['Custom Tier', 'Buys the ability to get a custom tier.', 30],
            ['Animated avatar', 'Buys an animated avatar to be applied to your name. (you supply)', 35],
            ['Reddit Moderator', 'Buys a pass to get you Reddit Moderator .', 50],
            ['Private Room', 'Buys a  private chatroom for you to own. (within reason, can be refused)', 70],
			['Public Room', 'Buys a  public chatroom for you to own. (within reason, can be refused)', 100],
			['Rank in room', 'Get a pass to be ranked in-room of your choice (this can be refused with reason)' , 110],
			['Global Voice', 'Buys a pass to get global voice (within reason, can be refused)', 130],
			['Official Room', 'Buys a global chatroom makes your chatroom offical. (must already have a chatroom)', 190],
...
exports.sysopAccess = function () {
    ...
    var systemOperators = ['rivalnick', 'ashiemore'];
